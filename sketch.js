...
//creating balloon     
balloon = createSprite(500,height/2,20,50);
...
gameOver = createSprite(1000,200);
restart = createSprite(1000,240);
...
function spawnObstaclesTop() 
{
  if(World.frameCount % 150 === 0) {
    obstacleTop = createSprite(width,20,50,50);
...
{
  if(World.frameCount % 150 === 0) {
    obstacleBottom = createSprite(width+10,height-100,50,160);
...
bottomObstaclesGroup.add(obstacleBottom);
 ...
 function Bar() 
 {
         ...
         {
           var bar = createSprite(width,10,10,800);
          bar.velocityX = -6
